...
class BlackBoxMFGSMValidator(Validator):

    def __init__(self, source_model, target_model, criterion, valid_queue, n_repeats, decay, clip_eps,
                 data_mean, data_std):
        # valid basic
    ...
    def valid(self, report_freq=50):
        ...
        for step, (image, target) in enumerate(self.valid_queue):
            ...
            # add noise to batch
            image_pert = mfgsm(model=self.source_model, criterion=self.criterion,
