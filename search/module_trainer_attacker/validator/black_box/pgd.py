...
class BlackBoxPGDValidator(Validator):

    def __init__(self, source_model, target_model, criterion, valid_queue, n_repeats, fgsm_step, clip_eps,
    ...
    def valid(self, report_freq=50):
        ...
        for step, (image, target) in enumerate(self.valid_queue):
            ...
            all_pert = pgd_attack(model=self.source_model, criterion=self.criterion,
