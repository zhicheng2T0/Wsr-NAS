...
class Architect(object):
    ...
    def __init__(self, search_objective_weights,model, momentum, weight_decay,
        ...
        self.predictor = DistributedDataParallel(self.predictor, device_ids=[local_rank], find_unused_parameters=True)
    ...
    def _backward_step(self):
        if self.is_gae:
            ...
            y_pred,oute0,oute1,oute2,oute3,oute4,oute5=self.predictor(self.model.arch_weights().unsqueeze(0))
